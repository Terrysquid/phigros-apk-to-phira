...
def set_buttons_state(state):
    ...
    settings_button.config(state=state)
...
load_button = ttk.Button(load_buttons_frame, text="加载", width=6, command=load)
...
#
clear_button = ttk.Button(search_frame, text="清空", width=6, command=clear_search)
clear_button.grid(row=3, column=2, sticky="e")
search_button = ttk.Button(search_frame, text="搜索", width=6, command=search)
...
export_button = ttk.Button(bottom_frame, text="导出", width=6, command=export)
